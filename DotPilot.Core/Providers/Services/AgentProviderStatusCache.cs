    ...
    : IAgentProviderStatusCache, IDisposable
{
    ...
    private ProviderStatusCacheSnapshot? _snapshot;
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                _snapshot = new ProviderStatusCacheSnapshot(providers, timeProvider.GetUtcNow());
    ...
    private bool IsExpired(ProviderStatusCacheSnapshot snapshot)
    {
