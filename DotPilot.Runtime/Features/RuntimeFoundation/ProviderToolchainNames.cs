...
internal static class ProviderToolchainNames
{
    public const string DeterministicClientDisplayName = "In-Repo Test Client";
    public const string DeterministicClientCommandName = "embedded";
    public const string CodexDisplayName = "Codex CLI";
