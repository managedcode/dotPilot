...
- **In scope for future implementation:** `Microsoft Agent Framework`, provider adapters, durable persistence beyond in-memory runtime state, telemetry, evaluation, Git tooling, and local runtimes.
